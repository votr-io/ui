...
export const CreateElectionMutation = gql`mutation CreateElection($input:CreateElectionRequest!){createElection(input:$input){__typename adminToken election{__typename description id name status}}}`
